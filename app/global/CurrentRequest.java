...
public class CurrentRequest extends Controller {
	...
	// Linking data with format PageName_ParameterName = ParameterValue (to optimize)
	//protected HashMap<String, String> pageParameters;//We prefer page cloning.
	...
	protected CurrentRequest(Page page, Request request, Context context) {
		...
		//this.pageParameters = new HashMap<String, String>();//We prefer page cloning.
	}
	
	/*
	 * We prefer page cloning.
	public void setPageParameter(String pageName, String paramName, String paramValue) {
